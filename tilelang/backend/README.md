...
| `tilelang/tenstorrent` | `tenstorrent` | Phase 1 verified no-op Device TIR skeleton for `wormhole_b0` and `blackhole`; Add lowering, TTL codegen, and TTNN execution are not implemented yet. |
